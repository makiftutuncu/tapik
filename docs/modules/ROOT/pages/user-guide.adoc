...
| Codecs
| +implementation("dev.akif.tapik:codec:0.2.4")+

| Jackson integration
| +implementation("dev.akif.tapik:jackson:0.2.4")+
...
[NOTE]
====
The version numbers match the repository snapshot (+version=0.2.4+). Replace them with the release you are consuming.
====
