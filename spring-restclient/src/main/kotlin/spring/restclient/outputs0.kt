...
fun RestClientInterpreter.sendWithRestClient(
    endpoint: HttpEndpoint<Parameters0, EmptyBody, Outputs0>
...
fun <P1 : Any> RestClientInterpreter.sendWithRestClient(
    endpoint: HttpEndpoint<Parameters1<P1>, EmptyBody, Outputs0>,
    p1: P1
): EmptyResponse<Nothing> {
    val response =
        send(
...
fun <P1 : Any, P2 : Any> RestClientInterpreter.sendWithRestClient(
    endpoint: HttpEndpoint<Parameters2<P1, P2>, EmptyBody, Outputs0>,
    p1: P1,
    p2: P2
): EmptyResponse<Nothing> {
    val response =
