...
class Tuple0<T> : Tuple<T> {
    operator fun <T1 : T> plus(item1: T1): Tuple1<T, T1> = Tuple1(item1)
...
data class Tuple8<T, T1 : T, T2 : T, T3 : T, T4 : T, T5 : T, T6 : T, T7 : T, T8 : T>(
    ...
    override fun toList(): List<T> = listOf(item1, item2, item3, item4, item5, item6, item7, item8)
}
...
data class Tuple9<T, T1 : T, T2 : T, T3 : T, T4 : T, T5 : T, T6 : T, T7 : T, T8 : T, T9 : T>(
    ...
    override fun toList(): List<T> = listOf(item1, item2, item3, item4, item5, item6, item7, item8, item9)
}
...
data class Tuple10<T, T1 : T, T2 : T, T3 : T, T4 : T, T5 : T, T6 : T, T7 : T, T8 : T, T9 : T, T10 : T>(
    ...
    override fun toList(): List<T> = listOf(item1, item2, item3, item4, item5, item6, item7, item8, item9, item10)
}
