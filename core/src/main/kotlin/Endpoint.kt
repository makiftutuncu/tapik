 ...
 * @param OutputHeaders tuple encapsulating outbound header definitions.
 * @param OutputBodies outbound body alternatives grouped by status matcher.
 ...
 * @property outputHeaders headers emitted in the response.
 * @property outputBodies candidate response bodies matched against returned status codes.
 */
abstract class Endpoint<out URIWithParameters, out InputHeaders, out InputBody, out OutputHeaders, out OutputBodies> {
