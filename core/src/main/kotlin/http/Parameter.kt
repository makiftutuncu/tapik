...
data class PathVariable<P: Any>(override val name: String, override val codec: StringCodec<P>) : Parameter<P> {
...
data class QueryParameter<Q: Any>(override val name: String, override val codec: StringCodec<Q>) : Parameter<Q> {
...
data class HeaderInput<H: Any>(override val name: String, override val codec: StringCodec<H>) : Header<H> {
    override val position: ParameterPosition = ParameterPosition.Header
}

data class HeaderValues<H: Any>(override val name: String, override val codec: StringCodec<H>, val values: List<H>) : Header<H> {
    override val position: ParameterPosition = ParameterPosition.Header
}
