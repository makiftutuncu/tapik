...
public interface BooksClient {
    ...
    public val restClientTransport: dev.akif.tapik.plugin.spring.restclient.RestClientTransport
    ...
    public fun list(
        ...
        return when {
            booksApi.list.outputs._1.matcher.matches(response.status) -> {
                dev.akif.tapik.plugin.spring.restclient.selectResponseBodyMediaType(response = response, offered = kotlin.collections.listOf(booksApi.list.outputs._1.bodies._1.mediaType), allowsNoBody = false, endpointId = "Books.list")
    ...
    public fun get(
        ...
        return when {
            booksApi.get.outputs._1.matcher.matches(response.status) -> {
                dev.akif.tapik.plugin.spring.restclient.selectResponseBodyMediaType(response = response, offered = kotlin.collections.listOf(booksApi.get.outputs._1.bodies._1.mediaType), allowsNoBody = false, endpointId = "Books.get")
            ...
            booksApi.get.outputs._2.matcher.matches(response.status) -> {
                dev.akif.tapik.plugin.spring.restclient.selectResponseBodyMediaType(response = response, offered = kotlin.collections.emptyList(), allowsNoBody = true, endpointId = "Books.get")
    ...
    public fun create(
        ...
        val response =
            restClientTransport.exchange(
                ...
                body = dev.akif.tapik.plugin.spring.restclient.RestClientRequestBody(booksApi.create.input.bodies._1.mediaType, booksApi.create.input.bodies._1.format.encode(body))
            )

        return when {
            booksApi.create.outputs._1.matcher.matches(response.status) -> {
                dev.akif.tapik.plugin.spring.restclient.selectResponseBodyMediaType(response = response, offered = kotlin.collections.listOf(booksApi.create.outputs._1.bodies._1.mediaType), allowsNoBody = false, endpointId = "Books.create")
            ...
            booksApi.create.outputs._2.matcher.matches(response.status) -> {
                dev.akif.tapik.plugin.spring.restclient.selectResponseBodyMediaType(response = response, offered = kotlin.collections.emptyList(), allowsNoBody = true, endpointId = "Books.create")
